...
class SendEnvelopeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'envelope_document' => ['nullable', 'array'],
            'envelope_document.document_url' => ['nullable', 'url', 'max:2048'],
            'envelope_document.document_title' => ['nullable', 'string', 'max:255'],
            'envelope_document.document_file_name' => ['nullable', 'string', 'max:255'],
            'envelope_document.document_file_content' => ['nullable', 'string'],
            'template_id' => ['nullable', 'string', 'max:255'],
            'template_title' => ['nullable', 'string', 'max:255'],
            'envelope_documents' => ['nullable', 'array', 'min:1'],
            'envelope_documents.*.document_title' => ['nullable', 'string', 'max:255'],
