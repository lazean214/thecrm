...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('deals/export', [DealExportController::class, 'export'])->name('deals.export');
    ...
    Route::view('internal-companies', 'internal-companies')->name('internal-companies');
...
// Company Import
Route::post('/import-companies', function (CompanyImportRequest $request) {
    try {
        Excel::import(
            new CompanyImport,
            $request->file('file')
